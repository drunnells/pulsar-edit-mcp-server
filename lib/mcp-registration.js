...
export function mcpRegistration(server) {
    ...
    server.registerTool(
      curTool,
      {
        ...
        description: [
          ...
          "Workflow hint: ALWAYS call `get-document` first for freshest text."
        ].join(" "),
      ...
      async ({ patch }) => {
        ...
        decorateEditedLines(editor, original, updated);
...

  {
    ...
    server.registerTool(curTool,
      {
        title: "Insert Line",
        description: "Insert the given text as a new line at the specified 1-based line number, shifting existing lines down. Prefer apply-patch, if possible.",
...

  {
    ...
    server.registerTool(
      ...
      {
        title: "Delete Line",
        description: "Delete the specified line number (1-based). Prefer apply-patch, if possible.",
...

  {
    ...
    server.registerTool(
      curTool,
      {
        ...
        description: "Delete all lines from startLine to endLine (inclusive). For a single line, set startLine === endLine. Line numbers are 1-based. Prefer apply-patch, if possible. Consider doing a get-document to confirm range is possible.",
