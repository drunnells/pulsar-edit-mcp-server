...
export default class ChatPanel {
    constructor(serializedState) {
        ...
        const chatDisplay = document.createElement('textarea');
        chatDisplay.setAttribute('readonly', true);
        chatDisplay.id = 'chat-display';
        chatDisplay.classList.add('input-textarea');
    ...
    handleSend() {
        ...
        if (chatInput.value) {
            handleSendMessage(chatDisplay, chatInput.value);
            chatInput.value = '';
        }
    }
